const UI = {
    ...
    showScreen(screenId) {
        ...
        if (questContainer) {
            questContainer.classList.toggle('hidden', screenId === 'hub-screen' || screenId === 'title-screen' || screenId === 'intro-screen'||screenId === 'briefing-screen'||screenId === 'tutorial-screen' );
        }
